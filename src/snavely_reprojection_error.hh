...
struct SnavelyReprojectionError {
  ...
  static SnavelyCostFunction* Create(
    ...
    SnavelyReprojectionError *projector = new SnavelyReprojectionError(x, y, focal, distortion);
    ...
    cost_fn->AddParameterBlock(3);           // 4: rotation
    cost_fn->AddParameterBlock(3);           // 5: translation
